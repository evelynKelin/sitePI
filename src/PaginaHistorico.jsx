// src/PaginaHistorico.jsx
import React, { useState, useEffect, useContext } from 'react';
import { UserContext } from './UserContext';
import { useNavigate } from 'react-router-dom';
import './App.css'; // Vamos usar o CSS existente
...
export default function PaginaHistorico() {
  ...
  if (loading) {
    return <div id="login"><div id="quad"><h2>Carregando histórico...</h2></div></div>;
  }

  if (erro) {
    return <div id="login"><div id="quad"><h2 className="erro">{erro}</h2></div></div>;
  }

  return (
    <div id="login">
      <div id="quad" style={{ width: '800px', textAlign: 'left' }}>
        ...
        <button onClick={() => navigate('/pag5')}>Continuar Comprando</button>
      </div>
    </div>
  );
}